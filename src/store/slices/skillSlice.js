...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://akkasdevbackendcode-production.up.railway.app/api/v1/skill/getall",
    ...
    dispatch(
      skillSlice.actions.getAllSkillsFailed(error)
    );
  }
};
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://akkasdevbackendcode-production.up.railway.app/api/v1/skill/add",
      data,
      {
        withCredentials: true,
    ...
    dispatch(skillSlice.actions.addNewSkillFailed(error));
  }
};
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://akkasdevbackendcode-production.up.railway.app/api/v1/skill/update/${id}`,
      { proficiency },
      {
        withCredentials: true,
    ...
    dispatch(skillSlice.actions.updateSkillFailed(error));
  }
};
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://akkasdevbackendcode-production.up.railway.app/api/v1/skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
    ...
    dispatch(skillSlice.actions.deleteSkillFailed(error));
  }
};
