...
export const getAllProjects = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://akkasdevbackendcode-production.up.railway.app/api/v1/project/getall",
    ...
    dispatch(
      projectSlice.actions.getAllProjectsFailed(error)
    );
  }
};
...
export const addNewProject = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      ...
      // "https://akkasdevbackendcode-production.up.railway.app/api/v1/project/add",
      data
      // data,
      // {
      //   withCredentials: true,
    ...
    dispatch(
      ...
      projectSlice.actions.addNewProjectFailed(error)
    );
  }
};
export const deleteProject = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://akkasdevbackendcode-production.up.railway.app/api/v1/project/delete/${id}`,
      {
        withCredentials: true,
      }
    );
    ...
    dispatch(
      projectSlice.actions.deleteProjectFailed(error)
    );
  }
};
export const updateProject = (id, newData) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://akkasdevbackendcode-production.up.railway.app/api/v1/project/update/${id}`,
      newData,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
    ...
    console.log(error);
    dispatch(
      projectSlice.actions.updateProjectFailed(error)
    );
  }
};
